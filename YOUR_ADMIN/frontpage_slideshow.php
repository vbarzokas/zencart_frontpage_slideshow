...
require(DIR_WS_MODULES . 'prod_cat_header_code.php');
	...
	if ( (isset($_POST["submit"])) && ($_FILES["file"]["name"] != "") )
	{
		...
		else
		{
			...
			{
				$slideshow_query = "INSERT INTO " . TABLE_SLIDESHOW. "(image,url,caption) VALUES ('$image','$url','$caption')";
	...
	{
		$slideshow_query = "UPDATE " . TABLE_SLIDESHOW. " SET caption='$caption' WHERE " . TABLE_SLIDESHOW.".image='$slide_edit' ";
		$slideshow_result = $db->Execute($slideshow_query );
